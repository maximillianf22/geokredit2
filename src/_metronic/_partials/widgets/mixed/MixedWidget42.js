...
export function MixedWidget42({ className, chartColor = "danger" }) {
  ...
  useEffect(() => {
    const element = document.getElementById("kt_mixed_widget_8_chart");
  ...
  return (
    <>
      ...
      <div
        className={`card card-custom bg-radial-gradient-info ${className}`}
      >
        {/* begin::Header */}
        <div className="card-header border-0 pt-5">
          <h3 className="card-title font-weight-bolder text-white">
            <b className="d-none d-sm-none d-md-block d-lg-block">Estadistica &nbsp;</b>Diaria
          </h3> 
        </div>
        {/* end::Header */}
...
function getChartOption(layoutProps) {
  const options = {
    ...
    xaxis: {
      categories: ["8:00am", "10:00am", "12:00am", "2:00pm", "4:00pm", "6:00pm", "8:00pm"],
      axisBorder: {
        show: false,
      },
      axisTicks: {

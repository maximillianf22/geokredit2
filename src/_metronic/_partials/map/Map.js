          ...
          <div className="row">
            <div className="col-md-3">
              <div className="d-flex align-items-center justify-content-between flex-grow-1">
                <span className="symbol-label h6 font-weight-bold mb-4 text-muted">
                  <small className="text-left text-primary">
                    Lun 3 de mayo
                  </small>
                  <h2 className="mb-0 lh-1 pb-0 text-dark ">Geoinforme</h2>{" "}
                  <br />
                  <strong className="font-weigth-bold">$150.000.000</strong>
                  -$150.000.000
                  <br />
                      ...
                      <div className="d-flex align-items-center my-5">
                        ...
                        <label className="checkbox checkbox-lg checkbox-light-primary checkbox-single flex-shrink-0 m-0 mx-4">
                          <input
                            type="checkbox"
                            value="1"
                            onChange={() => setHandlerB((curr) => curr + 1)}
                          />
                          <span></span>
                        </label>
                        <div className="d-flex flex-column flex-grow-1">
                          ...
                          <span className="text-muted font-weight-bold lh-1 ">
                            90% de progreso
                          </span>
                        </div>
                      </div>
                      <div className="d-flex align-items-center my-5">
                        ...
                        <label className="checkbox checkbox-lg checkbox-light-warning checkbox-single flex-shrink-0 m-0 mx-4">
                          <input
                            type="checkbox"
                            value="1"
                            onChange={() => setHandlerB((curr) => curr + 2)}
                          />
                          <span></span>
                        </label>
                        <div className="d-flex flex-column flex-grow-1">
            ...
            <div className="col-md-9">
              <div className="map">
                ...
                <div className="map__card d-sm-none d-none d-lg-block d-md-block">
                  ...
                  <div className="d-flex flex-column w-100 mr-2">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="text-muted mr-2 font-size-sm font-weight-bold"></span>

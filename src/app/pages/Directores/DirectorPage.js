...
import ModalCreate from "../../../_metronic/_partials/director/ModalCreate";
import ModalEdit from "../../../_metronic/_partials/director/ModalEdit";
import ModalDetail from "../../../_metronic/_partials/director/ModalDetail";
    ...
    <div className="row">
      <div className="col-md-12">
        <div className="card">
              ...
              <table className="table  table-vertical-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                      <span className="font-weight-bold">9/05/2021</span>
                    </td>
                    <td className="text-center">
          ...
          <ModalDetail show={showModalDetail} handleClose={handleCloseModalDetail} />
        </div>
      </div>
    </div>
  );
